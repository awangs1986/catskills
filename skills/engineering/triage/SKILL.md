...
4. **Grill (if needed).** If the request needs fleshing out, invoke the "grilling" skill and then the "domain-modeling" skill, and grill it into shape a round of questions at a time, sharpening domain terms and updating `CONTEXT.md`/ADRs inline as decisions land.
