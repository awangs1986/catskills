...
If the tickets came from [to-tickets](to-tickets.md), the tracker they live on was configured by [setup-matt-pocock-skills](setup-matt-pocock-skills.md). `code-review` reads the same configuration to find the originating spec at close-out.
